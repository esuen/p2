...
func (u *update) Run(ctx context.Context) (ret bool) {
	...
	go u.hcheck.WatchService(watchServiceCtx, string(newFields.Manifest.ID()), hChecks, hErrs, watchDelay, useHealthService, newFields.Manifest.GetStatusStanza(), u.logger)
